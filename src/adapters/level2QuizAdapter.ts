...
/** 适配 Level2 测验数据 */
export function adaptLevel2Quiz(rawData: RawLevelQuizItem[] | null): ProcessedLevelQuizItem[] {
...
/** 返回所有 Level2 题目（新数组） */
export function getAllLevel2Quizzes(data: ProcessedLevelQuizItem[]): ProcessedLevelQuizItem[] {
